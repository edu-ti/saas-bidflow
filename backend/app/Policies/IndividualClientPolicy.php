...
class IndividualClientPolicy
{
    ...
    public function delete(User $user, IndividualClient $model): bool { return $user->company_id === $model->company_id && ($user->isAdmin() || in_array($user->role?->name, ['Admin', 'Manager'])); }
}
