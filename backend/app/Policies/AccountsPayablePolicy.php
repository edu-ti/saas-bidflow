...
class AccountsPayablePolicy
{
    ...
    public function delete(User $user, AccountsPayable $model): bool { return $user->company_id === $model->company_id && ($user->isAdmin() || in_array($user->role?->name, ['Admin', 'Manager'])); }
}
