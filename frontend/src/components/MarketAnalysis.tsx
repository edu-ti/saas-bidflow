...
export default function MarketAnalysis() {
 ...
 className="w-full pl-11 pr-4 py-3 bg-bg-tertiary/50 border border-border rounded-xl text-sm text-text-primary placeholder:text-text-muted/50 focus:outline-none focus:border-primary/50 focus:ring-2 focus:ring-primary/20 transition-all"
 />
 </div>
 </div>
 ...
 <button className="w-full btn btn-primary py-4 flex items-center justify-center gap-3 mt-4">
 <Filter size={18} />
 Filtrar Dados
 </button>
 </div>
 ...
 Análise de <span className="text-primary">Mercado</span>
 </h1>
 </div>
 ...
 <div className="space-y-4">
 {topOrgs.map((org, idx) => (
 <div key={idx} className="flex items-center justify-between p-3 bg-bg-tertiary/30 rounded-xl">
 <div className="flex items-center gap-3">
 <span className="w-6 h-6 rounded-lg bg-primary/20 text-primary text-xs font-semibold flex items-center justify-center">
 {idx + 1}
 </span>
 <div>
 <p className="text-sm font-bold text-text-primary">{org.name}</p>
 <p className="text-xs text-text-muted">{org.count} licitações</p>
 </div>
 </div>
 ...
 <div key={idx} className="flex items-center justify-between p-3 bg-bg-tertiary/30 rounded-xl">
 <div className="flex items-center gap-3">
 <span className="w-6 h-6 rounded-lg bg-secondary/20 text-secondary text-xs font-semibold flex items-center justify-center">
 {idx + 1}
 </span>
 <div>
 <p className="text-sm font-bold text-text-primary">{supplier.name}</p>
 <p className="text-xs text-text-muted">{supplier.wins} vitórias</p>
 </div>
 </div>
 ...
 <th className="text-left px-6 py-4 text-xs font-semibold uppercase tracking-wider text-text-muted">ID</th>
 <th className="text-left px-6 py-4 text-xs font-semibold uppercase tracking-wider text-text-muted">Local</th>
 <th className="text-left px-6 py-4 text-xs font-semibold uppercase tracking-wider text-text-muted">Órgão</th>
 <th className="text-left px-6 py-4 text-xs font-semibold uppercase tracking-wider text-text-muted">Data</th>
 <th className="text-right px-6 py-4 text-xs font-semibold uppercase tracking-wider text-text-muted">Valor</th>
 </tr>
 </thead>
 <tbody>
 {recentBiddings.map((bid) => (
 <tr key={bid.id} className="border-b border-border/50 hover:bg-bg-tertiary/30 transition-colors">
