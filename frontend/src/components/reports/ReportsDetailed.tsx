    ...
    <div className="space-y-8 animate-fade-in">
      ...
      <div className="card p-5 flex flex-wrap items-center gap-6">
        <div className="flex items-center gap-3">
          ...
          <div className="flex gap-3">
            <div className="flex flex-col gap-1">
              <span className="text-[10px] font-medium text-text-muted uppercase">Mês</span>
              <div className="min-w-[130px]">
                <Select value={month.toString()} onChange={v => setMonth(Number(v))} options={months.map(m => ({ value: m.id.toString(), label: m.name }))} />
              </div>
            </div>
            <div className="flex flex-col gap-1">
              <span className="text-[10px] font-medium text-text-muted uppercase">Ano</span>
        ...
        <div className="flex items-center gap-3">
          ...
          <div className="flex flex-col gap-1">
            <span className="text-[10px] font-medium text-text-muted uppercase">Vendedor</span>
        ...
        <div className="flex items-center gap-3">
          ...
          <div className="flex flex-col gap-1">
            <span className="text-[10px] font-medium text-text-muted uppercase">Fornecedor</span>
            <div className="min-w-[180px]">
        ...
        <div className="flex items-center gap-3">
          ...
          <div className="flex flex-col gap-1">
            <span className="text-[10px] font-medium text-text-muted uppercase">Estado (UF)</span>
                ...
                <div key={i} className="card p-5 space-y-4 group hover:border-primary/30 transition-all">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <span className="text-[10px] text-text-muted">Consultor</span>
                    </div>
                  </div>
                  <div className="grid grid-cols-2 gap-3">
                    <div className="p-3 bg-bg-tertiary/30 rounded-lg">
                      <p className="text-[10px] text-text-muted mb-0.5">Vitórias</p>
