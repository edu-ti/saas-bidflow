...
...(prev[forn]?.[month] || {}),
 ...
 <div className="bg-primary rounded-xl p-8 text-white shadow-xl overflow-hidden relative dark:bg-primary/90">
 ...
 <div>
 <h3 className="text-2xl font-semibold tracking-tight">Performance Financeira</h3>
 <p className="text-white/80 text-xs font-bold uppercase tracking-wider mt-1">Gestão de metas e comissões por vendedor</p>
 </div>
 </div>

 <div className="flex flex-wrap items-center gap-4 bg-white/10 p-3 rounded-xl backdrop-blur-xl border border-white/10">
 <div className="flex items-center gap-2 bg-white/5 rounded-xl px-4 py-2 border border-white/5">
 <div className="flex flex-col">
 <span className="text-white/70 text-xs font-semibold uppercase">Início</span>
 <input
 type="date"
 value={startDate}
 ...
 <div className="flex flex-col">
 <span className="text-white/70 text-xs font-semibold uppercase">Fim</span>
 <input
 type="date"
 value={endDate}
 ...
 disabled={loading}
 className="bg-primary-foreground hover:bg-white/90 text-primary px-6 h-11 rounded-xl font-semibold uppercase text-xs tracking-widest transition-all shadow-lg active:scale-95 flex items-center gap-2 group disabled:opacity-50"
 >
 ...
 className="bg-emerald-500 hover:bg-emerald-400 text-white px-5 h-11 rounded-xl font-semibold uppercase text-xs tracking-widest transition-all flex items-center active:scale-95 shadow-lg"
 >
 <Download size={14} className="mr-2" />Exportar
 </button>
 <button
 onClick={openConfigModal}
 className="bg-amber-500 hover:bg-amber-400 text-white px-5 h-11 rounded-xl font-semibold uppercase text-xs tracking-widest transition-all flex items-center active:scale-95 shadow-lg"
 >
 ...
 {!hasData ? (
 <div className="bg-bg-secondary border border-dashed border-border rounded-xl p-20 text-center text-text-muted">
 ...
 <thead>
 <tr className="bg-primary text-primary-foreground text-sm font-semibold uppercase tracking-wider">
 ...
 <td className="px-5 py-3 text-sm text-right font-semibold text-text-primary font-mono">{formatCurrency(row.total_vendas || 0)}</td>
 ...
 {formatCurrency(comissao)} <span className="text-xs text-text-muted">({row.percentual_comissao || 1}%)</span>
 </td>
 ...
 <td className="px-5 py-3 text-sm text-right font-semibold text-text-primary bg-primary/10 font-mono">{formatCurrency(row.total_pagar || 0)}</td>
 </tr>
 );
 })}
 </tbody>
 ...
 return (
 <tr className="bg-bg-secondary dark:bg-slate-700 border-t-2 border-primary/20 font-semibold text-sm">
 ...
 <div className="relative bg-bg-primary dark:bg-slate-800 rounded-xl shadow-2xl w-full max-w-7xl max-h-[85vh] overflow-y-auto z-10 flex flex-col border border-border">
 ...
 <label className="text-xs font-semibold text-text-muted uppercase">Ano Base:</label>
 <input
 type="number"
 value={configYear}
 ...
 <thead>
 <tr className="bg-primary text-primary-foreground text-xs uppercase font-semibold tracking-widest">
 ...
 <Select
 value={config.usuario_id ? config.usuario_id.toString() : ''}
 onChange={(v) => updateVendedorRow(idx, 'usuario_id', parseInt(v))}
 options={users.map(u => ({ value: u.id.toString(), label: u.name || u.nome }))}
 />
 </td>
 <td className="px-4 py-3">
 <input
 ...
 className="text-primary hover:text-primary/80 text-xs font-semibold flex items-center gap-2 hover:bg-primary/10 px-4 py-2 rounded-xl transition-all border border-primary/20 bg-primary/5"
 >
 ...
 <h5 className="text-sm font-semibold text-emerald-600 uppercase tracking-wider flex items-center gap-2">
 <Calculator size={16} /> Metas por Fornecedor / Estados
 </h5>
 <button
 onClick={addSupplier}
 className="text-emerald-600 hover:text-emerald-800 text-xs font-semibold flex items-center gap-2 hover:bg-emerald-50 px-4 py-2 rounded-xl transition-all border border-emerald-200 bg-white dark:bg-slate-800 shadow-sm"
 >
 ...
 <div className="bg-emerald-600 text-white px-3 py-1 rounded-lg text-xs font-semibold uppercase">
 {forn}
 </div>
 <div className="flex items-center gap-3">
 ...
 <thead>
 <tr className="bg-bg-secondary dark:bg-slate-700 text-text-muted font-semibold uppercase text-xs">
 ...
 <span className="bg-blue-100 dark:bg-blue-900 text-blue-700 dark:text-blue-300 px-2 py-0.5 rounded font-semibold text-sm">{uf}</span>
 </td>
 ...
 className="w-full text-right text-sm font-mono border-0 bg-transparent focus:bg-bg-secondary focus:border focus:border-blue-300 dark:focus:border-blue-600 rounded px-1 py-0.5 outline-none transition-all text-text-primary"
 placeholder="-"
 />
 </td>
 );
 ...
 className="bg-primary hover:bg-primary/90 text-primary-foreground px-8 py-2.5 rounded-xl font-semibold text-sm shadow-lg active:scale-95 transition-all flex items-center gap-2 disabled:opacity-50"
 >
 ...
 <div className="flex justify-between items-center mb-4">
 <h4 className="font-semibold text-text-primary text-lg">Novo Fornecedor</h4>
 <button
 ...
 className="bg-primary hover:bg-primary/90 text-primary-foreground px-6 py-2 rounded-xl font-semibold text-sm shadow-lg active:scale-95 transition-all"
 >
 Adicionar
 </button>
 </div>
