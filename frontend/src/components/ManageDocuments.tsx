...
const typeStyles = {
 ...
 MANUAL: 'bg-bg-tertiary text-text-muted border-border'
};
...
export default function ManageDocuments() {
 ...
 Gerenciar <span className="text-primary">Documentos</span>
 </h1>
 ...
 className="w-4 h-4 rounded border-border bg-bg-tertiary text-primary focus:ring-primary/20 focus:ring-offset-0 cursor-pointer"
 />
 ...
 className="w-full pl-12 pr-4 py-3 bg-bg-secondary/50 backdrop-blur-xl border border-border rounded-2xl text-sm text-text-primary placeholder:text-text-muted/50 focus:outline-none focus:border-primary/50 focus:ring-2 focus:ring-primary/20 transition-all"
 />
 </div>
 <div className="flex items-center gap-3">
 <button className="flex items-center gap-2 px-5 py-3 bg-bg-tertiary border border-border rounded-2xl text-sm font-medium text-text-secondary hover:text-primary hover:border-primary/30 transition-all">
 <Bell size={18} />
 Notificações
 </button>
 <button className="flex items-center gap-2 px-5 py-3 bg-bg-tertiary border border-border rounded-2xl text-sm font-medium text-text-secondary hover:text-primary hover:border-primary/30 transition-all">
 ...
 <button className="flex items-center gap-2 px-6 py-3 bg-gradient-to-r from-emerald-500 to-emerald-600 text-white font-semibold text-xs uppercase tracking-wider rounded-2xl hover:scale-[1.02] transition-transform shadow-lg">
 ...
 <th className="text-left px-6 py-4 text-xs font-semibold uppercase tracking-wider text-text-muted">Documento</th>
 <th className="text-left px-6 py-4 text-xs font-semibold uppercase tracking-wider text-text-muted">Tipo</th>
 <th className="text-left px-6 py-4 text-xs font-semibold uppercase tracking-wider text-text-muted">Grupo</th>
 <th className="text-left px-6 py-4 text-xs font-semibold uppercase tracking-wider text-text-muted">Situação</th>
 <th className="text-left px-6 py-4 text-xs font-semibold uppercase tracking-wider text-text-muted">Vencimento</th>
 <th className="text-right px-6 py-4 text-xs font-semibold uppercase tracking-wider text-text-muted">Ações</th>
 </tr>
 </thead>
 <tbody>
 {filteredDocuments.map((doc) => (
 <tr key={doc.id} className="border-b border-border/50 hover:bg-bg-tertiary/30 transition-colors">
 ...
 <td className="px-6 py-4">
 <span className={`px-3 py-1 text-xs font-semibold uppercase tracking-wider border rounded-full ${typeStyles[doc.type as keyof typeof typeStyles]}`}>
 ...
 <span className={`px-3 py-1 text-xs font-semibold uppercase tracking-wider border rounded-full ${statusStyles[doc.status as keyof typeof statusStyles]}`}>
 ...
 <button className="w-8 h-8 rounded-lg bg-bg-tertiary flex items-center justify-center text-text-muted hover:text-primary hover:bg-primary/10 transition-all">
 <Eye size={16} />
 </button>
 <button className="w-8 h-8 rounded-lg bg-bg-tertiary flex items-center justify-center text-text-muted hover:text-primary hover:bg-primary/10 transition-all">
 <Download size={16} />
 </button>
 <button className="w-8 h-8 rounded-lg bg-bg-tertiary flex items-center justify-center text-text-muted hover:text-text-primary hover:bg-bg-secondary transition-all">
 ...
 <div className="flex items-center gap-2">
 <button className="px-3 py-1 rounded-lg bg-bg-tertiary hover:bg-bg-secondary text-text-secondary hover:text-text-primary transition-all">Anterior</button>
 <button className="px-3 py-1 rounded-lg bg-primary/10 text-primary font-medium">1</button>
 <button className="px-3 py-1 rounded-lg bg-bg-tertiary hover:bg-bg-secondary text-text-secondary hover:text-text-primary transition-all">Próximo</button>
 </div>
 </div>
 </main>
 </div>
