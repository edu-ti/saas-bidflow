...
function PhaseIndicator({ phase }: { phase: string }) {
 ...
 <div className={`
 w-6 h-6 rounded-lg flex items-center justify-center text-xs font-semibold uppercase
 ${idx <= currentIndex ? phaseLabels[phase].bg : 'bg-bg-tertiary'}
...
export default function ManageBiddings() {
 ...
 Gerenciar <span className="text-primary">Licitações</span>
 </h1>
 ...
 <div className="bg-bg-secondary/50 backdrop-blur-xl border border-border rounded-2xl p-5 flex items-center gap-4 hover:border-primary/30 transition-all">
 <div className="w-14 h-14 rounded-2xl bg-primary/10 flex items-center justify-center">
 <Calendar size={28} className="text-primary" />
 </div>
 <div>
 <p className="text-xs font-semibold uppercase tracking-wider text-text-muted">Calendário</p>
 ...
 <div>
 <p className="text-xs font-semibold uppercase tracking-wider text-text-muted">Favoritadas</p>
 <p className="text-xl font-semibold text-text-primary">{stats.favorited}</p>
 </div>
 </div>
 ...
 <div>
 <p className="text-xs font-semibold uppercase tracking-wider text-text-muted">Gerenciadas</p>
 <p className="text-xl font-semibold text-text-primary">{stats.managed}</p>
 </div>
 </div>
 ...
 <div>
 <p className="text-xs font-semibold uppercase tracking-wider text-text-muted">Andamentos</p>
 <p className="text-xl font-semibold text-text-primary">{stats.ongoing}</p>
 </div>
 </div>
 ...
 <div>
 <p className="text-xs font-semibold uppercase tracking-wider text-text-muted">Finalizadas</p>
 <p className="text-xl font-semibold text-text-primary">{stats.finished}</p>
 </div>
 </div>
 </div>
 ...
 <div
 key={bidding.id}
 className="bg-bg-secondary/50 backdrop-blur-xl border border-border rounded-3xl p-6 space-y-5 hover:border-primary/30 hover:ring-2 hover:ring-primary/20 transition-all duration-300"
 >
 <div className="flex items-center justify-between gap-4 pb-4 border-b border-border">
 <div className="flex items-center gap-4">
 <span className="text-xs font-mono text-text-muted bg-bg-tertiary px-2 py-1 rounded">
 {bidding.id}
 </span>
 <PhaseIndicator phase={bidding.phase} />
 </div>
 <span className={`px-3 py-1 text-xs font-semibold uppercase tracking-wider border rounded-full ${phaseLabels[bidding.phase].bg} ${phaseLabels[bidding.phase].color} border-current`}>
 ...
 <div>
 <p className="text-xs font-semibold uppercase tracking-wider text-text-muted">Abertura</p>
 <p className="font-bold text-text-primary">{bidding.openingDate}</p>
 </div>
 <div>
 <p className="text-xs font-semibold uppercase tracking-wider text-text-muted">Órgão</p>
 <p className="font-bold text-text-primary truncate">{bidding.agency}</p>
 </div>
 <div>
 <p className="text-xs font-semibold uppercase tracking-wider text-text-muted">UF</p>
 <p className="font-bold text-text-primary">{bidding.uf}</p>
 </div>
 <div>
 <p className="text-xs font-semibold uppercase tracking-wider text-text-muted">Modalidade</p>
 <p className="font-bold text-text-primary truncate">{bidding.modality}</p>
 </div>
 <div>
 <p className="text-xs font-semibold uppercase tracking-wider text-text-muted">Valor Estimado</p>
 ...
 <button className="flex items-center gap-2 px-4 py-2 bg-bg-tertiary hover:bg-primary/10 border border-border hover:border-primary/30 rounded-xl text-sm font-medium text-text-secondary hover:text-primary transition-all">
 <Eye size={16} />
 Ver itens
 </button>
 <button className="flex items-center gap-2 px-4 py-2 bg-bg-tertiary hover:bg-primary/10 border border-border hover:border-primary/30 rounded-xl text-sm font-medium text-text-secondary hover:text-primary transition-all">
 ...
 <button className="flex items-center gap-2 px-4 py-2 bg-bg-tertiary hover:bg-red-500/10 border border-border hover:border-red-500/30 rounded-xl text-sm font-medium text-text-secondary hover:text-red-400 transition-all">
 ...
 <button className="flex items-center justify-center w-10 h-10 rounded-xl bg-bg-tertiary border border-border hover:border-primary/30 text-text-muted hover:text-primary transition-all">
 ...
 <div key={idx} className="p-3 bg-bg-tertiary/50 rounded-xl text-sm text-text-secondary">
 {note}
 </div>
 ))}
 </div>
