...
export default function BiddingBulletin() {
 ...
 Boletim de <span className="text-primary">Licitações</span>
 </h1>
 </div>
 ...
 <button className="flex items-center gap-3 px-6 py-3 bg-gradient-to-r from-primary to-accent text-white font-semibold text-xs uppercase tracking-wider rounded-2xl hover:scale-[1.02] transition-transform ">
 <Sparkles size={16} />
 Resumo do Boletim
 </button>
 </header>

 <div className="flex items-center gap-4 p-4 bg-bg-secondary/50 backdrop-blur-xl border border-border rounded-2xl relative z-20">
 <div className="flex-1">
 <label className="text-xs font-semibold uppercase tracking-wider text-text-muted mb-2 block">Situação</label>
 ...
 <div className="flex-1">
 <label className="text-xs font-semibold uppercase tracking-wider text-text-muted mb-2 block">Estados</label>
 <div className="relative">
 <Select 
 value={state}
 onChange={setState}
 ...
 <div className="flex-1">
 <label className="text-xs font-semibold uppercase tracking-wider text-text-muted mb-2 block">Status</label>
 <div className="relative">
 <Select 
 value={status}
 onChange={setStatus}
 ...
 key={result.id}
 className={`
 relative bg-bg-secondary/50 backdrop-blur-xl border rounded-3xl p-6 space-y-5 transition-all duration-300 group
 ${result.isUrgent ? 'border-red-500/50 hover:border-red-500 hover:ring-2 hover:ring-red-500/20' : 'border-border hover:border-primary/30 hover:ring-2 hover:ring-primary/20'}
 `}
 >
 {result.isUrgent && (
 <div className="absolute -top-3 -right-3 flex items-center gap-1 px-3 py-1 bg-red-500 text-white text-xs font-semibold uppercase tracking-wider rounded-full shadow-lg">
 ...
 <span className={`px-3 py-1 text-xs font-semibold uppercase tracking-wider border rounded-full ${statusColors[result.status]}`}>
 {result.status}
 </span>
 </div>
 </div>
 ...
 <div>
 <p className="text-xs font-semibold uppercase tracking-wider text-text-muted">Valor</p>
 ...
 : 'bg-bg-tertiary hover:bg-primary/10 border-border hover:border-primary/30 text-text-secondary hover:text-primary'
 }
 `}
 >
