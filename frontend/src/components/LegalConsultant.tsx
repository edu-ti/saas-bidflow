...
export default function LegalConsultant() {
 ...
 <header className="flex items-center gap-4 p-6 border-b border-border bg-bg-secondary/50 backdrop-blur-xl">
 <button
 ...
 Consultor <span className="text-primary">Jurídico</span>
 </h1>
 ...
 ${msg.role === 'assistant'
 ? 'bg-bg-secondary/50 border border-border'
 ...
 <div className="bg-bg-secondary/50 border border-border rounded-3xl p-5">
 ...
 <div className="flex items-center gap-3 p-4 bg-bg-secondary border border-border rounded-3xl focus-within:border-primary/50 focus-within:ring-2 focus-within:ring-primary/20 transition-all">
 <button className="w-10 h-10 rounded-xl bg-bg-tertiary flex items-center justify-center text-text-muted hover:text-primary hover:bg-primary/10 transition-all">
 <Mic size={18} />
 </button>
 <input
 type="text"
