...
export default function BiddingSearch() {
 ...
 <div className="bg-bg-secondary/50 backdrop-blur-xl border border-border rounded-3xl p-6 sticky top-6 space-y-6">
 ...
 className="w-full px-4 py-3 bg-bg-tertiary/50 border border-border rounded-xl text-sm text-text-primary placeholder:text-text-muted/50 focus:outline-none focus:border-primary/50 focus:ring-2 focus:ring-primary/20 transition-all"
 />
 </div>
 ...
 type="checkbox"
 id="international"
 className="w-5 h-5 rounded border-border bg-bg-tertiary/50 text-primary focus:ring-primary/20 focus:ring-offset-0 cursor-pointer"
 />
 ...
 className="w-full btn btn-primary py-4 flex items-center justify-center gap-3"
 >
 <Search size={18} />
 Pesquisar
 </button>
 ...
 <div
 key={result.id}
 className="bg-bg-secondary/50 backdrop-blur-xl border border-border rounded-3xl p-6 space-y-5 hover:border-primary/30 hover:ring-2 hover:ring-primary/20 transition-all duration-300 group"
 >
 ...
 <span className="px-2 py-1 text-xs font-bold uppercase tracking-wider bg-accent/20 text-accent border border-accent/30 rounded-full">
 INTERNACIONAL
 </span>
 )}
 </div>
