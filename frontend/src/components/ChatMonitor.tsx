...
export default function ChatMonitor() {
 ...
 <aside className="w-96 border-r border-border bg-bg-secondary/50 flex flex-col">
 ...
 Monitorar <span className="text-primary">Chat</span>
 </h1>
 </div>
 ...
 className={`flex-1 py-2 px-3 text-xs font-semibold uppercase tracking-wider rounded-xl transition-all ${filter === 'me' ? 'bg-primary text-white' : 'bg-bg-tertiary text-text-muted hover:text-text-primary'}`}
 >
 Por mim
 </button>
 <button
 onClick={() => setFilter('all')}
 className={`flex-1 py-2 px-3 text-xs font-semibold uppercase tracking-wider rounded-xl transition-all ${filter === 'all' ? 'bg-primary text-white' : 'bg-bg-tertiary text-text-muted hover:text-text-primary'}`}
 >
 Por todos
 </button>
 </div>
 ...
 className="w-full pl-10 pr-4 py-2.5 bg-bg-tertiary/50 border border-border rounded-xl text-sm text-text-primary placeholder:text-text-muted/50 focus:outline-none focus:border-primary/50"
 />
 </div>
 </div>
 ...
 className={`w-full p-4 border-b border-border text-left transition-all hover:bg-bg-tertiary/50 ${
 selectedBid.id === bid.id ? 'bg-bg-tertiary border-l-2 border-l-primary' : ''
 }`}
 >
 ...
 <span className={`px-2 py-0.5 text-xs font-semibold uppercase tracking-wider border rounded-full ${portalColors[bid.portal]}`}>
 {bid.portal}
 </span>
 </div>
 </button>
 ...
 <div className="flex items-center gap-2">
 <span className="font-semibold text-text-primary">{selectedBid.code}</span>
 <span className={`px-2 py-0.5 text-xs font-semibold uppercase tracking-wider border rounded-full ${portalColors[selectedBid.portal]}`}>
 {selectedBid.portal}
 </span>
 </div>
 ...
 <button className="w-9 h-9 rounded-lg bg-bg-tertiary flex items-center justify-center text-text-muted hover:text-primary hover:bg-primary/10 transition-all">
 <Check size={16} />
 </button>
 <button className="w-9 h-9 rounded-lg bg-bg-tertiary flex items-center justify-center text-text-muted hover:text-primary hover:bg-primary/10 transition-all">
 <RefreshCw size={16} />
 ...
 <div className="absolute right-0 top-full mt-2 w-56 bg-bg-secondary border border-border rounded-2xl shadow-xl opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all z-50">
 <div className="p-2 space-y-1">
 <button className="w-full flex items-center gap-3 px-3 py-2 text-sm text-text-secondary hover:text-primary hover:bg-bg-tertiary rounded-xl transition-all">
 ...
 className="w-full flex items-center gap-3 px-3 py-2 text-sm text-text-secondary hover:text-primary hover:bg-bg-tertiary rounded-xl transition-all"
 >
 ...
 <div className="p-4 border-b border-border bg-bg-secondary/20 relative z-20">
 <div className="flex items-center gap-3">
 <span className="text-xs font-semibold uppercase tracking-wider text-text-muted">Filtrar por lote:</span>
 <div className="relative">
 <Select
 value={selectedLote}
 ...
 <div
 key={msg.id}
 className="p-4 bg-bg-secondary/30 border border-border rounded-2xl hover:border-primary/20 transition-all"
 >
 <div className="flex items-center justify-between mb-2">
 <div className="flex items-center gap-2">
 <span className="text-xs font-semibold uppercase tracking-wider text-text-muted">{msg.sender}</span>
 {msg.hasKeyword && (
 <span className="px-2 py-0.5 text-xs font-bold bg-primary/20 text-primary border border-primary/30 rounded-full flex items-center gap-1">
 <AlertCircle size={10} />
