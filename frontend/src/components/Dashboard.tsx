...
...goalForm,
 ...
 <button
 onClick={() => navigate('/reports?tab=goals')}
 ...
 <div className="flex items-center gap-1 text-xs font-semibold text-success bg-success/10 px-1.5 py-0.5 rounded">
 ...
 <p className="text-xs font-medium text-text-muted uppercase tracking-widest">Vendas Aprovadas</p>
 </div>
 );
 }) : (
