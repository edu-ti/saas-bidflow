                              ...
                              <div className="space-y-3">
                                ...
                                <div className="flex justify-between items-end pt-3 border-t border-border">
                                  <div className="space-y-0.5">
                                    <span className="text-[10px] font-semibold text-text-muted uppercase tracking-wider block">Valor</span>
                                  ...
                                  <div className="flex flex-col items-end gap-1.5">
                                    <span className={`text-[9px] font-semibold px-1.5 py-0.5 rounded border uppercase ${opp.type === 'bidding' ? 'bg-secondary/10 text-secondary border-secondary/20' : 'bg-primary/10 text-primary border-primary/20'}`}>
                                    ...
                                    {opp.win_probability && (
                                      <div className="flex items-center gap-1.5">
                                        ...
                                        <span className="text-[9px] text-text-muted font-medium">{opp.win_probability}</span>
                                      </div>
                                    )}
                                  </div>
                                </div>
