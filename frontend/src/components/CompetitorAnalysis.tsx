...
export default function CompetitorAnalysis() {
 ...
 Análise de <span className="text-primary">Concorrentes</span>
 </h1>
 ...
 <div className="bg-bg-secondary/50 backdrop-blur-xl border border-border rounded-3xl p-6">
 ...
 className="w-full pl-12 pr-4 py-4 bg-bg-tertiary/50 border border-border rounded-2xl text-sm text-text-primary placeholder:text-text-muted/50 focus:outline-none focus:border-primary/50 focus:ring-2 focus:ring-primary/20 transition-all"
 />
 </div>
 <button className="px-8 py-4 bg-primary text-white font-semibold text-xs uppercase tracking-wider rounded-2xl hover:bg-primary/90 transition-all ">
 Buscar
 </button>
 </div>
 </div>
 ...
 <div>
 <h2 className="text-xl font-semibold text-text-primary">{COMPETITOR_DATA.name}</h2>
 ...
 <span className="text-xs font-semibold uppercase tracking-wider text-yellow-500">Desclassificações</span>
 </div>
 <p className="text-3xl font-semibold text-yellow-400">23</p>
 </div>
 <div className="bg-yellow-900/20 border border-yellow-500/30 rounded-3xl p-5">
 <div className="flex items-center gap-3 mb-2">
 <UserX size={20} className="text-yellow-500" />
 <span className="text-xs font-semibold uppercase tracking-wider text-yellow-500">Inabilitações</span>
 </div>
 <p className="text-3xl font-semibold text-yellow-400">12</p>
 </div>
 <div className="bg-yellow-900/20 border border-yellow-500/30 rounded-3xl p-5">
 <div className="flex items-center gap-3 mb-2">
 <Ban size={20} className="text-yellow-500" />
 <span className="text-xs font-semibold uppercase tracking-wider text-yellow-500">Sanções</span>
 </div>
 <p className="text-3xl font-semibold text-yellow-400">3</p>
 </div>
 </div>

 <div className="bg-bg-secondary/50 backdrop-blur-xl border border-border rounded-3xl overflow-hidden">
 <button
 onClick={() => setShowAdmin(!showAdmin)}
 className="w-full p-6 flex items-center justify-between hover:bg-bg-tertiary/30 transition-colors"
 >
 <div className="flex items-center gap-3">
 <Building2 size={20} className="text-primary" />
 <h3 className="text-sm font-semibold uppercase tracking-wider text-text-primary">Análise Administrativa</h3>
 </div>
 ...
 <div className="p-4 bg-bg-tertiary/30 rounded-2xl">
 <div className="flex items-center gap-2 mb-2">
 <MapPin size={14} className="text-text-muted" />
 <span className="text-xs font-semibold uppercase tracking-wider text-text-muted">Endereço</span>
 </div>
 ...
 <span className="text-xs font-semibold uppercase tracking-wider text-text-muted">Telefone</span>
 </div>
 ...
 <span className="text-xs font-semibold uppercase tracking-wider text-text-muted">E-mail</span>
 </div>
 ...
 <span className="text-xs font-semibold uppercase tracking-wider text-text-muted">Sócios</span>
 </div>
 ...
 <div className="p-4 bg-bg-tertiary/30 rounded-2xl">
 <span className="text-xs font-semibold uppercase tracking-wider text-text-muted mb-3 block">Segmentos / CNAEs</span>
 ...
 <h3 className="text-sm font-semibold uppercase tracking-wider text-text-primary">Participações</h3>
 </div>
 ...
 <div className="p-4 bg-bg-tertiary/30 rounded-2xl text-center">
 <p className="text-xs font-semibold uppercase tracking-wider text-text-muted mb-2">Disputas Participadas</p>
 <p className="text-2xl font-semibold text-text-primary">{participationData.total}</p>
 </div>
 <div className="p-4 bg-emerald-500/10 border border-emerald-500/30 rounded-2xl text-center">
 <p className="text-xs font-semibold uppercase tracking-wider text-emerald-500 mb-2">Vencidas</p>
 <p className="text-2xl font-semibold text-emerald-400">{participationData.won}</p>
 </div>
 <div className="p-4 bg-red-500/10 border border-red-500/30 rounded-2xl text-center">
 <p className="text-xs font-semibold uppercase tracking-wider text-red-500 mb-2">Não Vencidas</p>
 <p className="text-2xl font-semibold text-red-400">{participationData.lost}</p>
 </div>
 <div className="p-4 bg-bg-tertiary/30 rounded-2xl text-center">
 <p className="text-xs font-semibold uppercase tracking-wider text-text-muted mb-2">Valor Total Vencido</p>
 <p className="text-2xl font-semibold text-emerald-400">{formatCurrency(participationData.totalValue)}</p>
 </div>
 </div>

 <div className="p-4 bg-bg-tertiary/30 rounded-2xl">
 <span className="text-xs font-semibold uppercase tracking-wider text-text-muted mb-4 block">Vitórias vs Derrotas</span>
 ...
 <MapPin size={14} className="text-text-muted" />
 <span className="text-xs font-semibold uppercase tracking-wider text-text-muted">Contratos por Estado</span>
 </div>
 ...
 <span className="text-xs font-semibold uppercase tracking-wider text-text-muted">Itens Vencidos</span>
 </div>
 <div className="space-y-3">
 ...
 <h3 className="text-sm font-semibold uppercase tracking-wider text-text-primary">Sanções / Penalizações</h3>
 </div>
 ...
 className="w-full px-4 py-3 bg-bg-tertiary/50 border border-border rounded-xl text-sm text-text-primary placeholder:text-text-muted/50 focus:outline-none focus:border-primary/50"
 />
 <div className="bg-bg-tertiary rounded-2xl overflow-hidden">
 <table className="w-full">
 <thead>
 <tr className="border-b border-border/50">
 <th className="text-left px-4 py-3 text-xs font-semibold uppercase tracking-wider text-text-muted">Órgão Sancionador</th>
 <th className="text-left px-4 py-3 text-xs font-semibold uppercase tracking-wider text-text-muted">Sanção</th>
 <th className="text-left px-4 py-3 text-xs font-semibold uppercase tracking-wider text-text-muted">Início</th>
 <th className="text-left px-4 py-3 text-xs font-semibold uppercase tracking-wider text-text-muted">Fim</th>
 <th className="text-left px-4 py-3 text-xs font-semibold uppercase tracking-wider text-text-muted">Status</th>
 </tr>
 </thead>
 <tbody>
 {sanctions.map((s) => (
 <tr key={s.id} className="border-b border-border/30 hover:bg-bg-secondary/30 transition-colors">
 ...
 <div className="flex items-center gap-3">
 <TrendingUp size={20} className="text-primary" />
 <h3 className="text-sm font-semibold uppercase tracking-wider text-text-primary">Aspectos Estratégicos</h3>
 </div>
 ...
 <span className="text-xs font-semibold uppercase tracking-wider text-text-muted">Principais Motivos para Desclassificação / Inabilitação</span>
 </div>
